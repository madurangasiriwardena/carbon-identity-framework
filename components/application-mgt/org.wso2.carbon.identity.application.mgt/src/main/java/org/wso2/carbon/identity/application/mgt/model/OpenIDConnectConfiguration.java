...
public class OpenIDConnectConfiguration {
    ...
    public enum StateEnum {
        ...
        @XmlEnumValue("ACTIVE") ACTIVE(String.valueOf("ACTIVE")), @XmlEnumValue("REVOKED") REVOKED(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.clientId, openIDConnectConfiguration.clientId) &&
                ...
                Objects.equals(this.validateRequestObjectSignature,
                        openIDConnectConfiguration.validateRequestObjectSignature) &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(clientId, clientSecret, state, grantTypes, callbackURLs, allowedOrigins, publicClient, pkce,
                accessToken, refreshToken, idToken, logout, validateRequestObjectSignature, scopeValidators);
    }
    ...
    public String toString() {
        ...
        sb.append("    validateRequestObjectSignature: ").append(toIndentedString(validateRequestObjectSignature))
                .append("\n");
