...
import org.wso2.carbon.identity.application.mgt.model.ClaimMappings;
import org.wso2.carbon.identity.application.mgt.model.RequestedClaimConfiguration;
import org.wso2.carbon.identity.application.mgt.model.RoleConfig;
import org.wso2.carbon.identity.application.mgt.model.SubjectConfig;
...
public class UpdateClaimConfiguration implements UpdateFunction<ServiceProvider, ClaimConfiguration> {
    ...
    private RoleMapping buildRoleMapping(org.wso2.carbon.identity.application.mgt.model.RoleMapping roleMapping) {
