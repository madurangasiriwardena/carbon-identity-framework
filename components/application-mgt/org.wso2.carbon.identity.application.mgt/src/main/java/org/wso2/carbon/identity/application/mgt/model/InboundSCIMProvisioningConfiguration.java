...
public class InboundSCIMProvisioningConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        InboundSCIMProvisioningConfiguration inboundSCIMProvisioningConfiguration =
                (InboundSCIMProvisioningConfiguration) o;
        return Objects.equals(this.proxyMode, inboundSCIMProvisioningConfiguration.proxyMode) &&
                Objects.equals(this.provisioningUserstoreDomain,
                        inboundSCIMProvisioningConfiguration.provisioningUserstoreDomain);
    }
    ...
    public String toString() {
        ...
        sb.append("    provisioningUserstoreDomain: ").append(toIndentedString(provisioningUserstoreDomain))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
