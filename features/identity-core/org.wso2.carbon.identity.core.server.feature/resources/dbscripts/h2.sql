...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_V2 (
           TOKEN_ID VARCHAR (255),
           ACCESS_TOKEN VARCHAR (2048),
           REFRESH_TOKEN VARCHAR (2048),
           CONSUMER_KEY_ID INTEGER,
           AUTHZ_USER_ID VARCHAR (100),
           TENANT_ID INTEGER,
           USER_DOMAIN VARCHAR(50),
           USER_TYPE VARCHAR (25),
           GRANT_TYPE VARCHAR (50),
           ...
           PRIMARY KEY (TOKEN_ID),
           FOREIGN KEY (CONSUMER_KEY_ID) REFERENCES IDN_OAUTH_CONSUMER_APPS(ID) ON DELETE CASCADE,
           CONSTRAINT CON_APP_KEY UNIQUE (CONSUMER_KEY_ID,AUTHZ_USER_ID,TENANT_ID,USER_DOMAIN,USER_TYPE,
                                          TOKEN_SCOPE_HASH,TOKEN_STATE,TOKEN_STATE_ID,IDP_ID,TOKEN_BINDING_REF)
);
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_TOKEN_BINDING_V2 (
           TOKEN_ID VARCHAR (255),
           TOKEN_BINDING_TYPE VARCHAR (32),
           TOKEN_BINDING_REF VARCHAR (32),
           TOKEN_BINDING_VALUE VARCHAR (1024),
           TENANT_ID INTEGER DEFAULT -1,
           UNIQUE (TOKEN_ID,TOKEN_BINDING_TYPE,TOKEN_BINDING_VALUE),
           FOREIGN KEY (TOKEN_ID) REFERENCES IDN_OAUTH2_ACCESS_TOKEN_V2(TOKEN_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT_V2 (
         TOKEN_ID VARCHAR (255),
         ACCESS_TOKEN VARCHAR(2048),
         REFRESH_TOKEN VARCHAR(2048),
         CONSUMER_KEY_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_AUTHORIZATION_CODE_V2 (
                 CODE_ID VARCHAR (255),
                 AUTHORIZATION_CODE VARCHAR (2048),
                 CONSUMER_KEY_ID INTEGER,
                 CALLBACK_URL VARCHAR (2048),
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_AUTHZ_CODE_SCOPE_V2(
          CODE_ID   VARCHAR(255),
          SCOPE     VARCHAR(60),
          TENANT_ID INTEGER DEFAULT -1,
          PRIMARY KEY (CODE_ID, SCOPE),
          FOREIGN KEY (CODE_ID) REFERENCES IDN_OAUTH2_AUTHORIZATION_CODE_V2 (CODE_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_SCOPE_V2 (
            TOKEN_ID VARCHAR (255),
            TOKEN_SCOPE VARCHAR (60),
            TENANT_ID INTEGER DEFAULT -1,
            PRIMARY KEY (TOKEN_ID, TOKEN_SCOPE),
...
CREATE TABLE IF NOT EXISTS IDN_OIDC_REQ_OBJECT_REFERENCE_V2 (
     ID INTEGER NOT NULL AUTO_INCREMENT,
     CONSUMER_KEY_ID INTEGER ,
     CODE_ID VARCHAR(255) ,
     TOKEN_ID VARCHAR(255) ,
...
CREATE TABLE IF NOT EXISTS IDN_OIDC_REQ_OBJECT_CLAIMS_V2 (
  ID INTEGER NOT NULL AUTO_INCREMENT,
  REQ_OBJECT_ID INTEGER,
  CLAIM_ATTRIBUTE VARCHAR(255) ,
  ESSENTIAL CHAR(1) NOT NULL DEFAULT '0',
  ...
  IS_USERINFO CHAR(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (ID),
  FOREIGN KEY (REQ_OBJECT_ID) REFERENCES IDN_OIDC_REQ_OBJECT_REFERENCE_V2 (ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS IDN_OIDC_REQ_OBJ_CLAIM_VALUES_V2 (
 ID INTEGER NOT NULL AUTO_INCREMENT,
 REQ_OBJECT_CLAIMS_ID INTEGER ,
 CLAIM_VALUES VARCHAR(255) ,
 PRIMARY KEY (ID),
 FOREIGN KEY (REQ_OBJECT_CLAIMS_ID) REFERENCES  IDN_OIDC_REQ_OBJECT_CLAIMS_V2(ID) ON DELETE CASCADE
);
...
CREATE INDEX IDX_TC ON IDN_OAUTH2_ACCESS_TOKEN_V2(TIME_CREATED);
CREATE INDEX IDX_ATH ON IDN_OAUTH2_ACCESS_TOKEN_V2(ACCESS_TOKEN_HASH);
CREATE INDEX IDX_AT_CK_AU ON IDN_OAUTH2_ACCESS_TOKEN_V2(CONSUMER_KEY_ID, AUTHZ_USER_ID, TOKEN_STATE, USER_TYPE);
CREATE INDEX IDX_AT_TI_UD ON IDN_OAUTH2_ACCESS_TOKEN_V2(AUTHZ_USER_ID, TENANT_ID, TOKEN_STATE, USER_DOMAIN);
CREATE INDEX IDX_AT_AU_TID_UD_TS_CKID ON IDN_OAUTH2_ACCESS_TOKEN_V2(AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, TOKEN_STATE,
                                                                    CONSUMER_KEY_ID);
CREATE INDEX IDX_AT_AT ON IDN_OAUTH2_ACCESS_TOKEN_V2(ACCESS_TOKEN);
CREATE INDEX IDX_AT_AU_CKID_TS_UT ON IDN_OAUTH2_ACCESS_TOKEN_V2(AUTHZ_USER_ID, CONSUMER_KEY_ID, TOKEN_STATE, USER_TYPE);
CREATE INDEX IDX_AT_RTH ON IDN_OAUTH2_ACCESS_TOKEN_V2(REFRESH_TOKEN_HASH);
CREATE INDEX IDX_AT_RT ON IDN_OAUTH2_ACCESS_TOKEN_V2(REFRESH_TOKEN);
...
CREATE INDEX IDX_AUTHORIZATION_CODE_HASH ON IDN_OAUTH2_AUTHORIZATION_CODE_V2 (AUTHORIZATION_CODE_HASH, CONSUMER_KEY_ID);
CREATE INDEX IDX_AUTHORIZATION_CODE_AU_TI ON IDN_OAUTH2_AUTHORIZATION_CODE_V2 (AUTHZ_USER_ID, TENANT_ID, USER_DOMAIN, STATE);
CREATE INDEX IDX_AC_CKID ON IDN_OAUTH2_AUTHORIZATION_CODE_V2(CONSUMER_KEY_ID);
CREATE INDEX IDX_AC_TID ON IDN_OAUTH2_AUTHORIZATION_CODE_V2(TOKEN_ID);
CREATE INDEX IDX_AC_AC_CKID ON IDN_OAUTH2_AUTHORIZATION_CODE_V2(AUTHORIZATION_CODE, CONSUMER_KEY_ID);
CREATE INDEX IDX_AT_CKID_AU_TID_UD_TSH_TS ON IDN_OAUTH2_ACCESS_TOKEN(CONSUMER_KEY_ID, AUTHZ_USER_ID, TENANT_ID,
...
CREATE INDEX IDX_IDN_AUTH_BIND ON IDN_OAUTH2_TOKEN_BINDING_V2 (TOKEN_BINDING_REF);
CREATE INDEX IDX_TK_VALUE_TYPE ON IDN_OAUTH2_TOKEN_BINDING_V2 (TOKEN_BINDING_VALUE, TOKEN_BINDING_TYPE);
